    ...
    public function run()
    {
        ...
        \App\Model\mstDisability::insert([
                ...
                [
                    ...
                    'name' => 'Down Syndrom',
                    'en' => 'Down Syndrom',
                    'detail' => 'Down syndrome adalah kondisi genetik yang menyebabkan gangguan belajar dan ciri fisik tertentu. Kondisi ini berlangsung seumur hidup, namun dengan perawatan yang tepat, orang dengan Down syndrome dapat bertumbuh dengan sehat, hidup dengan bahagia dan produktif bagi lingkungan.',
                    'created_at' => now()->addSecond($this->no += 1),
                    'updated_at' => now()->addSecond($this->no),
                ],
                [
                    ...
                    'name' => 'cerebral palsy',
                    'en' => 'cerebral palsy',
                    'detail' => 'Cerebral palsy adalah nama sekelompok kondisi yang memengaruhi otot dan saraf. Penyakit ini bukan bawaan, tapi dimulai dari tahap awal kehidupan yaitu sejak lahir. Ada tiga jenis cerebral palsy (CP) adalah spastic (paling umum), athetoid, dan ataxic.',
                    'created_at' => now()->addSecond($this->no += 1),
                    'updated_at' => now()->addSecond($this->no),
                ],
/*
