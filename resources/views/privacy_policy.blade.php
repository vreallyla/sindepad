        ...
        <div class="container">
            <div class="row">
                <div class="ed_counter_wrapper">
                    ...
                    <p>{{env('APP_NAME')}} ("us", "we", or "our") operates the {{env('APP_URL')}} website (the
                        "Service").</p>
                    ...
                    <p>This page informs you of our policies regarding the collection, use, and disclosure of personal
                        ...
                        Policy for Sanggar ABK is based on the <a
                    ...
                    <p>Cookies are files with small amount of data which may include an anonymous unique identifier.
                        Cookies are sent to
                        your browser from a website and stored on your device. Tracking technologies also used are
                        beacons, tags, and
                    ...
                    <p>{{env('APP_NAME')}} uses the collected data for various purposes:</p>
                    <ul>
                    ...
                    <p>If you are located outside Indonesia and choose to provide information to us, please note that we
                        transfer the
                        data, including Personal Data, to Indonesia and process it there.</p>
                    <p>Your consent to this Privacy Policy followed by your submission of such information represents
                        your agreement to
                        that transfer.</p>
                    <p>{{env('APP_NAME')}} will take all steps reasonably necessary to ensure that your data is treated
                        securely
                        and in
                    ...
                    <p>{{env('APP_NAME')}} may disclose your Personal Data in the good faith belief that such action is
                        necessary to:</p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of {{env('APP_NAME')}}</li>
                    ...
                    <ul>
                        <li>By email: {{env('MAIL_USERNAME')}}</li>
                        <li>By visiting this page on our website: {{route('contact')}}</li>

                        <li>By phone number: {{$default[0]->phone}}</li>
                    </ul>
                </div>
            </div>
        </div>
