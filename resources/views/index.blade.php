                            ...
                            <ul>
                                ...
                                <li data-transition="slotslide-horizontal">
                                    ...
                                    <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                        ...
                                        We help students reach their life goals
                                    </div>
                                    <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                ...
                                <li data-transition="slotslide-vertical">
                                    ...
                                    <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                         ...
                                         style="z-index: 5; white-space: nowrap; font-size: 50px; color:#fff;     font-family: 'Roboto Slab', serif;">
                                        When you come and we make sure
                                    </div>
                                    <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                            ...
                            @foreach($default[1] as $row)
                                <div class="item">
                                    <div class="ed_item_img">
                                        <img src="{{asset('storage/program-content/menari.jpg')}}" alt="item1"
                                             class="img-responsive">
                                    </div>
                                    <div class="ed_item_description">
                                        <h4>{{$row->name}}</h4>
                                        <p>{{substr($row->detail,0,110)}} ...</p>
                                        <a href="#" class="ed_getinvolved">Selengkapnya <i
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="skill_section">
                        ...
                        <p>We excell in multiple areas, but there are some in which we are absolutely rocking. Better
                            click now and see.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="ed_video_section_discription">
                        ...
                        <p>Nam cursus imperdiet elit. Fusce sollicitudin eget nulla in condimentum. Nullam dignissim id
                            magna non tempus. Vivamus molestie nulla nec pharetra dignissim. Suspendisse auctor nisi et
                            neque vehicula pulvinar. Quisque quis tempus magna. Quisque sed luctus nunc sapien.</p>
                        ...
                        <div id="owl-demo3" class="owl-carousel owl-theme">
                            <div class="item">
                                ...
                                <div class="ed_item_description ed_most_recomended_data">
                                    ...
                                    <p>Project-Based Learning is a flexible tool for framing given academic standards
                                        into curriculum flexible tool for framing.</p>
                                    <a href="course_single.html" class="ed_getinvolved">get involved <i
                                                class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="ed_item_description ed_most_recomended_data">
                                    ...
                                    <div class="course_detail">
                                        <div class="course_faculty">
                                            <img src="http://placehold.it/32X32" alt=""> <a
                                                    href="instructor_dashboard.html">DESPERATE SCOTT</a>
                                        </div>
                                    </div>
                                    <p>Project-Based Learning is a flexible tool for framing given academic standards
                                        into curriculum flexible tool for framing.</p>
                            ...
                            <div class="item">
                                ...
                                <div class="ed_item_description ed_most_recomended_data">
                                    ...
                                    <div class="course_detail">
                                        <div class="course_faculty">
                                            <img src="http://placehold.it/32X32" alt=""> <a
                                                    href="instructor_dashboard.html">MIKE TUSSLE</a>
                                        </div>
                                    </div>
                                    <p>Project-Based Learning is a flexible tool for framing given academic standards
                                        into curriculum flexible tool for framing.</p>
                            ...
                            <div class="item">
                                ...
                                <div class="ed_item_description ed_most_recomended_data">
                                    ...
                                    <div class="course_detail">
                                        <div class="course_faculty">
                                            <img src="http://placehold.it/32X32" alt=""> <a
                                                    href="instructor_dashboard.html"> JAMES MARCO</a>
                                        </div>
                                    </div>
                                    <p>Project-Based Learning is a flexible tool for framing given academic standards
                                        into curriculum flexible tool for framing.</p>
                            ...
                            <div class="item">
                                ...
                                <div class="ed_item_description ed_most_recomended_data">
                                    ...
                                    <div class="course_detail">
                                        <div class="course_faculty">
                                            <img src="http://placehold.it/32X32" alt=""> <a
                                                    href="instructor_dashboard.html"> ANDRE HOUSE</a>
                                        </div>
                                    </div>
                                    <p>Project-Based Learning is a flexible tool for framing given academic standards
                                        into curriculum flexible tool for framing.</p>
                            ...
                            <div class="item">
                                ...
                                <div class="ed_item_description ed_most_recomended_data">
                                    ...
                                    <div class="course_detail">
                                        <div class="course_faculty">
                                            <img src="http://placehold.it/32X32" alt=""> <a
                                                    href="instructor_dashboard.html"> FRANK PASCAL</a>
                                        </div>
                                    </div>
                                    <p>Project-Based Learning is a flexible tool for framing given academic standards
                                        into curriculum flexible tool for framing.</p>
                    ...
                    <div id="owl-demo2" class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="ed_item_description">
                                ...
                                <p>Just in case there is anyone looking for it, we added new expertise to our knowledge
                                    base to make you happy as well.</p>
                        ...
                        <div class="item">
                            <div class="ed_item_description">
                                ...
                                <p> Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae,
                                    eleifend ac, enim. Aliquam lorem ante. </p>
                                <a href="">read more <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="ed_item_description">
                                ...
                                <p>Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet.
                                    Etiam ultricies nisi vel augue.</p>
                                <a href="">read more <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="ed_item_description">
                                <h4>Officially the best</h4>
                                <p> Maecenas tempus, tellus eget condimentum, sem quam semper libero, sit amet scing sem
                                    neque sed ipsum.</p>
                                <a href="">read more <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="ed_item_description">
                                <h4>Redesigned website</h4>
                                <p>Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem to our knowledge
                                    base to make you happy as well.</p>
                                <a href="">read more <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
