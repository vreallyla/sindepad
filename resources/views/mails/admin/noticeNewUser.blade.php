                                        ...
                                        <tr>
                                            <td class="email-content-block copy"
                                                ...
                                                <h2 style='margin: 0 0 0.5rem 0; line-height: 1.25; font-family: "Avenir Next", "Avenir", "Helvetica", sans-serif !important; color: #3e474c; font-size: 2rem; font-weight: 500; font-style: normal;'>
                                                    yth. sdr/i {{array_key_exists('short',$user)?$user['short']:$user['name']}},</h2>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>Nama</td><td> : {{$user['name']}}</td><td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Email</td><td> : {{$user['email']}}</td><td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Password</td><td> : {{$user['password']}}</td><td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Hak Akses</td><td> : {{$user['role']}}</td><td></td>
                                                    </tr>
                                                </table>
                                                ...
                                                <center style='font-family: "Avenir Next", "Avenir", "Helvetica", sans-serif !important;'>
                                                    ...
                                                    <div class="section"
                                                        ...
                                                        <a class="button" href="{{asset('verify-account/'.$user['code'])}}"
                                                           target="_blank"
