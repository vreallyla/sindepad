...
@section('content')
    ...
    add-margin-top-hp card-mod" style="display: block">
                ...
                <div class="parent-card">
                    ...
                    <div class="card-detail"><h3 data-toggle="tooltip" data-placement="top" title="Ihsan Adriansyah">
                       ...
                       <div class="parent-process">
                           <h5>Target: Rp5.000</h5>
                           <div class="progress" data-toggle="tooltip" data-placement="top" title="Dapat: Rp2.000K">
                               <div class="determinate" style="width: 70%"></div>
                           </div>
                       </div>
                        <label>Selengkapnya</label></div>
                </div>
            </div>
        </div>
        ...
        @include('admin.fundraising.modalFullfundraising')
    </div>
