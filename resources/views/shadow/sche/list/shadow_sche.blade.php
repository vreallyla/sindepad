...
@section('content')
    <div id="student-schedule">
        ...
        <div class="col-lg-10 col-lg-offset-1 col-lg-offset col-md-12 col-sm-12 col-xs-12 table-register" style="display: block">
            <table class="table">
                <thead>
                <tr>
                    <th>Nama</th>
        ...
        @include('shadow.sche.list.modalFulShaSche')
    </div>
